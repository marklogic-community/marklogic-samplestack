...
@Component
public class UserServiceImpl extends AbstractMarkLogicDataService implements UserService  {
	...
	public void store(User user) {
		...
		jsonDocumentManager.write("/user/" + user.getId(),
