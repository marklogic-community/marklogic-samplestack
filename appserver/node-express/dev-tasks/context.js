...
self = module.exports = {
  ...
  restartServer: function () {
    ...
    setTimeout(function () {
      serverChild = require('child_process').fork('main.js');
    }, 100);
  },
  ...
  //           // cover js files that aren't .unit.js and are not ext
  //           // dependencies
