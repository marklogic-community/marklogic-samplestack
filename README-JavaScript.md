...
The default for Samplestack allows Java developers running the Java/Spring-based middle-tier to use a pre-built instance of the browser application with the Spring server -- **all hosted on port 8090 by default**.

Likewise, the default also allows JavaScript developers running the Node.js/Express-based to use a live (in-development) instance of the browser application with the Node.js server -- **all hosted on port 3000 by default**.
