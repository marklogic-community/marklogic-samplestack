...
curl --user admin:admin --digest -Haccept:"application/json" "http://localhost:8006/v1/search?q=tag:rest&directory=/questions/&options=questions&view=facets&format=json"  | python -mjson.tool
